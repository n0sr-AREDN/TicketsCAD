...
try {
    ...
    // Scoped to THIS test's own message. An unscoped "does user 3 have any
    // visible message at all" check (the previous form of this query) broke
    // the moment user 3 had any other real message -- confirmed 2026-08-06
    // against a genuine PAR-overdue alert generated by this dev box's own
    // scheduled-job system, not leftover test data. Soft-delete correctness
    // is about THIS message's visibility, not a global inbox count.
