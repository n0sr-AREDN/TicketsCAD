-- ============================================================
-- TicketsCAD NewUI v4 - base schema (idempotent)
--
-- Creates ~110 base tables required by the v4 migration runner
-- (sql/run_migrations.php). SAFE to run on any database state:
--
--   - Empty DB     -> creates all tables + seed data
--   - Partial DB   -> creates only missing tables
--   - Populated DB -> no-op (CREATE IF NOT EXISTS + INSERT IGNORE
--                     leave existing schema + data untouched)
--
-- Re-running this file repeatedly is safe.
--
-- Need to wipe and reinstall from scratch? See
-- sql/base_schema_RESET_DESTRUCTIVE.sql instead.
-- ============================================================

/*M!999999\- enable the sandbox mode */ 
-- MariaDB dump 10.19-11.8.3-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: ticketscad
-- ------------------------------------------------------
...
--
-- Database creation + USE statements intentionally stripped.
-- The original mariadb-dump header force-pointed every import to
-- a database called `ticketscad`, ignoring whatever DB the operator
-- piped this file into (`mysql <theirdb> < base_schema.sql`).
-- Now the import inherits the database from the mysql client
-- invocation, which is the expected fresh-install behavior.
--
-- If your DB doesn't exist yet, create it FIRST:
--   sudo mariadb -e "CREATE DATABASE newui CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_ai_ci;"
-- Then import:
--   sudo mariadb newui < sql/base_schema.sql
...
--
-- Table structure for table `ajax_log`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `ajax_log` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `info` text NOT NULL,
...
--
-- Dumping data for table `ajax_log`
--

LOCK TABLES `ajax_log` WRITE;
/*!40000 ALTER TABLE `ajax_log` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `ajax_log` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `allocates` VALUES
...
--
-- Table structure for table `auto_disp_status`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `auto_disp_status` (
...
--
-- Dumping data for table `auto_disp_status`
--

LOCK TABLES `auto_disp_status` WRITE;
/*!40000 ALTER TABLE `auto_disp_status` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `auto_disp_status` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `auto_status`
--
...
--
-- Dumping data for table `auto_status`
--

LOCK TABLES `auto_status` WRITE;
/*!40000 ALTER TABLE `auto_status` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `auto_status` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `capability_types`
--
...
--
-- Dumping data for table `capability_types`
--

LOCK TABLES `capability_types` WRITE;
/*!40000 ALTER TABLE `capability_types` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `capability_types` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `captions` VALUES
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `certs_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `certs_x_user`
--

LOCK TABLES `certs_x_user` WRITE;
/*!40000 ALTER TABLE `certs_x_user` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `certs_x_user` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
LOCK TABLES `clothing_types` WRITE;
/*!40000 ALTER TABLE `clothing_types` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `clothing_types` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `codes` VALUES
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `courses_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `courses_x_user`
--

LOCK TABLES `courses_x_user` WRITE;
/*!40000 ALTER TABLE `courses_x_user` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `courses_x_user` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `css_day`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `css_day` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `css_day`
--

LOCK TABLES `css_day` WRITE;
/*!40000 ALTER TABLE `css_day` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `css_day` VALUES
...
(24,'sev_text','000000');
/*!40000 ALTER TABLE `css_day` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `css_night`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `css_night` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
  `name` tinytext DEFAULT NULL,
  `value` tinytext DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `css_night`
--

LOCK TABLES `css_night` WRITE;
/*!40000 ALTER TABLE `css_night` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `css_night` VALUES
...
(23,'sev_background','EFEFEF'),
(24,'sev_text','000000');
/*!40000 ALTER TABLE `css_night` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `defined_fields`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `defined_fields` (
...
--
-- Dumping data for table `defined_fields`
--

LOCK TABLES `defined_fields` WRITE;
/*!40000 ALTER TABLE `defined_fields` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `defined_fields` VALUES
...
/*!40000 ALTER TABLE `defined_fields` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
LOCK TABLES `documents_log` WRITE;
/*!40000 ALTER TABLE `documents_log` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `documents_log` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `fac_case_cat`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `fac_case_cat` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fac_case_cat`
--

LOCK TABLES `fac_case_cat` WRITE;
/*!40000 ALTER TABLE `fac_case_cat` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `fac_case_cat` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `fac_status`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `fac_status` (
  `id` bigint(4) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fac_status`
--

LOCK TABLES `fac_status` WRITE;
/*!40000 ALTER TABLE `fac_status` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `fac_status` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `fac_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(48) NOT NULL,
...
LOCK TABLES `fac_types` WRITE;
/*!40000 ALTER TABLE `fac_types` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `fac_types` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `facnotes`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `facnotes` (
...
--
-- Dumping data for table `facnotes`
--

LOCK TABLES `facnotes` WRITE;
/*!40000 ALTER TABLE `facnotes` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `facnotes` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `fieldsets` VALUES
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `files_x` (
...
LOCK TABLES `files_x` WRITE;
/*!40000 ALTER TABLE `files_x` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `files_x` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `hints` VALUES
...
LOCK TABLES `in_types` WRITE;
/*!40000 ALTER TABLE `in_types` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `in_types` VALUES
(1,'examp1','Example one',NULL,0,0,'grp 1',1,0,NULL,0,NULL,NULL,1),
(2,'examp2','Example two',NULL,0,0,'grp 2',2,0,NULL,0,NULL,NULL,1);
/*!40000 ALTER TABLE `in_types` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `insurance` VALUES
...
--
-- Table structure for table `known_sources`
--
...
--
-- Dumping data for table `known_sources`
--

LOCK TABLES `known_sources` WRITE;
/*!40000 ALTER TABLE `known_sources` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `known_sources` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `mailgroup`
--
...
--
-- Dumping data for table `mailgroup`
--

LOCK TABLES `mailgroup` WRITE;
/*!40000 ALTER TABLE `mailgroup` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `mailgroup` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `mailgroup_x`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mailgroup_x` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mailgroup_x`
--

LOCK TABLES `mailgroup_x` WRITE;
/*!40000 ALTER TABLE `mailgroup_x` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `mailgroup_x` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `major_incidents`
--
...
--
-- Dumping data for table `major_incidents`
--

LOCK TABLES `major_incidents` WRITE;
/*!40000 ALTER TABLE `major_incidents` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `major_incidents` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `mdb_files`
--
...
--
-- Dumping data for table `mdb_files`
--

LOCK TABLES `mdb_files` WRITE;
/*!40000 ALTER TABLE `mdb_files` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `mdb_files` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `mdb_settings`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mdb_settings` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
  `name` tinytext DEFAULT NULL,
...
--
-- Dumping data for table `mdb_settings`
--

LOCK TABLES `mdb_settings` WRITE;
/*!40000 ALTER TABLE `mdb_settings` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `mdb_settings` VALUES
(1,'use_mdb_contact','0'),
(2,'use_mdb_status','0'),
...
/*!40000 ALTER TABLE `mdb_settings` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `messages_bin`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `messages_bin` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `msg_type` int(2) NOT NULL,
  `message_id` varchar(24) DEFAULT NULL,
  `ticket_id` int(8) DEFAULT NULL,
...
--
-- Dumping data for table `messages_bin`
--

LOCK TABLES `messages_bin` WRITE;
/*!40000 ALTER TABLE `messages_bin` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `messages_bin` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `mi_types`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mi_types` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `mi_types`
--

LOCK TABLES `mi_types` WRITE;
/*!40000 ALTER TABLE `mi_types` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `mi_types` VALUES
(1,'Environmental','transparent','#000000',1,'2015-02-27 11:50:34','::1');
/*!40000 ALTER TABLE `mi_types` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `mi_x`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mi_x` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `mi_x`
--

LOCK TABLES `mi_x` WRITE;
/*!40000 ALTER TABLE `mi_x` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `mi_x` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mmarkup` (
  `id` bigint(4) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `mmarkup` WRITE;
/*!40000 ALTER TABLE `mmarkup` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `mmarkup` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `mmarkup_cats` (
  `id` bigint(4) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `mmarkup_cats` WRITE;
/*!40000 ALTER TABLE `mmarkup_cats` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `mmarkup_cats` VALUES
...
/*!40000 ALTER TABLE `mmarkup_cats` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `msg_settings`
--
...
--
-- Dumping data for table `msg_settings`
--

LOCK TABLES `msg_settings` WRITE;
/*!40000 ALTER TABLE `msg_settings` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `msg_settings` VALUES
(1,'email_server',''),
(2,'email_port',''),
...
/*!40000 ALTER TABLE `msg_settings` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `patient_x`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `patient_x` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `patient_x`
--

LOCK TABLES `patient_x` WRITE;
/*!40000 ALTER TABLE `patient_x` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `patient_x` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `pin_ctrl`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `pin_ctrl` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pin_ctrl`
--

LOCK TABLES `pin_ctrl` WRITE;
/*!40000 ALTER TABLE `pin_ctrl` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `pin_ctrl` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `region_type` VALUES
...
--
-- Table structure for table `remote_devices`
--
...
--
-- Dumping data for table `remote_devices`
--

LOCK TABLES `remote_devices` WRITE;
/*!40000 ALTER TABLE `remote_devices` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `remote_devices` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `replacetext`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `replacetext` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `replacetext`
--

LOCK TABLES `replacetext` WRITE;
/*!40000 ALTER TABLE `replacetext` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `replacetext` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `replacetext_order`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `replacetext_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `replacetext_order`
--

LOCK TABLES `replacetext_order` WRITE;
/*!40000 ALTER TABLE `replacetext_order` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `replacetext_order` VALUES
(1,1,'add_ticket'),
(2,2,'add_user'),
(3,3,'add_user_unit'),
(4,4,'add_time'),
...
(15,15,'app_priority'),
(16,16,'app_warnings');
/*!40000 ALTER TABLE `replacetext_order` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `responder_rota`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `responder_rota` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `responder_rota`
--

LOCK TABLES `responder_rota` WRITE;
/*!40000 ALTER TABLE `responder_rota` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `responder_rota` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `responder_x_member`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `responder_x_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `responder_x_member`
--

LOCK TABLES `responder_x_member` WRITE;
/*!40000 ALTER TABLE `responder_x_member` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `responder_x_member` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `roadinfo`
--
...
--
-- Dumping data for table `roadinfo`
--

LOCK TABLES `roadinfo` WRITE;
/*!40000 ALTER TABLE `roadinfo` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `roadinfo` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `showin_contactlist`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `showin_contactlist` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `showin_contactlist`
--

LOCK TABLES `showin_contactlist` WRITE;
/*!40000 ALTER TABLE `showin_contactlist` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `showin_contactlist` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Dumping data for table `skills_x_user`
--

LOCK TABLES `skills_x_user` WRITE;
/*!40000 ALTER TABLE `skills_x_user` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `skills_x_user` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `sound_settings`
--
...
--
-- Dumping data for table `sound_settings`
--

LOCK TABLES `sound_settings` WRITE;
/*!40000 ALTER TABLE `sound_settings` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `sound_settings` VALUES
...
/*!40000 ALTER TABLE `sound_settings` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `states_translator`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `states_translator` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `states_translator`
--

LOCK TABLES `states_translator` WRITE;
/*!40000 ALTER TABLE `states_translator` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `states_translator` VALUES
(1,'Alabama','AL'),
(2,'Alaska','AK'),
(3,'Arizona','AZ'),
(4,'Arkansas','AR'),
...
/*!40000 ALTER TABLE `states_translator` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `stats_settings`
--
...
--
-- Dumping data for table `stats_settings`
--

LOCK TABLES `stats_settings` WRITE;
/*!40000 ALTER TABLE `stats_settings` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `stats_settings` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `stats_type` (
...
set autocommit=0;
INSERT IGNORE INTO `stats_type` VALUES
...
--
-- Table structure for table `std_msgs`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `std_msgs` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(48) NOT NULL,
...
--
-- Dumping data for table `std_msgs`
--

LOCK TABLES `std_msgs` WRITE;
/*!40000 ALTER TABLE `std_msgs` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `std_msgs` VALUES
(1,'Example Standard Message','Example Standard Message','Messages',1,0,0,0,0);
/*!40000 ALTER TABLE `std_msgs` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `teams_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `teams_x_user`
--

LOCK TABLES `teams_x_user` WRITE;
/*!40000 ALTER TABLE `teams_x_user` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `teams_x_user` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
--
-- Table structure for table `tracks_hh`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `tracks_hh` (
  `id` bigint(7) NOT NULL AUTO_INCREMENT,
  `source` varchar(96) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
...
--
-- Dumping data for table `tracks_hh`
--

LOCK TABLES `tracks_hh` WRITE;
/*!40000 ALTER TABLE `tracks_hh` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `tracks_hh` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
LOCK TABLES `training_packages` WRITE;
/*!40000 ALTER TABLE `training_packages` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `training_packages` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
LOCK TABLES `un_status` WRITE;
/*!40000 ALTER TABLE `un_status` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `un_status` VALUES
...
/*!40000 ALTER TABLE `un_status` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
set autocommit=0;
INSERT IGNORE INTO `unit_types` VALUES
...
set autocommit=0;
-- User seed rows intentionally stripped from base_schema.
--
-- The source v3.44 dump shipped two seeded accounts:
--   user.id=1 'admin' / MD5('admin')
--   user.id=2 'guest' / MD5('guest')
--
-- Both are publicly-known credentials. Shipping them in every
-- fresh install would mean any internet-facing v4 deployment is
-- compromised the moment Section 8.5 (import base_schema)
-- completes, before the operator gets to Section 10.
--
-- Removed so fresh installs start admin-less; create the first
-- admin via Section 10's `tools/create_admin.php` instead.
--
-- Existing v3.44-era installs that already have these rows are
-- not affected by this edit (they import this only on fresh
-- installs).
...
--
-- Table structure for table `waste_basket_f`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `waste_basket_f` (
  `id` smallint(3) NOT NULL AUTO_INCREMENT,
  `member_id` smallint(3) NOT NULL,
  `name` varchar(64) NOT NULL,
  `shortname` varchar(32) NOT NULL,
...
--
-- Dumping data for table `waste_basket_f`
--

LOCK TABLES `waste_basket_f` WRITE;
/*!40000 ALTER TABLE `waste_basket_f` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `waste_basket_f` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `waste_basket_m`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE IF NOT EXISTS `waste_basket_m` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `field1` varchar(28) DEFAULT NULL,
  `field2` varchar(28) DEFAULT NULL,
  `field3` int(4) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `waste_basket_m`
--

LOCK TABLES `waste_basket_m` WRITE;
/*!40000 ALTER TABLE `waste_basket_m` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `waste_basket_m` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `wizard_settings`
--
...
--
-- Dumping data for table `wizard_settings`
--

LOCK TABLES `wizard_settings` WRITE;
/*!40000 ALTER TABLE `wizard_settings` DISABLE KEYS */;
set autocommit=0;
INSERT IGNORE INTO `wizard_settings` VALUES
...
/*!40000 ALTER TABLE `wizard_settings` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Dumping events for database 'ticketscad'
--

--
-- Dumping routines for database 'ticketscad'
--
...
-- Dump completed on 2026-03-01  5:32:57
