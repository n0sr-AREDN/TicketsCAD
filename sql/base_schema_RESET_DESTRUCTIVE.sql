-- ============================================================
-- !!! DESTRUCTIVE — DROPS ALL TABLES BEFORE RECREATION !!!
--
-- This file WILL ERASE ALL DATA in any table it touches.
-- Do NOT use this on a database with data you want to keep.
--
-- The default install uses sql/base_schema.sql (idempotent,
-- safe for any database). This RESET variant exists only for
-- legitimate "wipe and reinstall from scratch" scenarios:
--    - rebuilding a test/staging instance
--    - recovering from corrupt base tables on a fresh install
--    - dev workflow where you intentionally want a clean slate
--
-- If you don't have a recent backup, STOP. Run:
--    sudo mariadb-dump <dbname> > backup-$(date +%F).sql
-- before continuing.
-- ============================================================
...
-- Import inherits the database from the mysql client invocation
-- (`mysql <theirdb> < base_schema_RESET_DESTRUCTIVE.sql`).
...
DROP TABLE IF EXISTS `ajax_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ajax_log` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
  `info` text NOT NULL,
...
DROP TABLE IF EXISTS `auto_disp_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `auto_disp_status` (
...
DROP TABLE IF EXISTS `capability_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `certs_x_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `certs_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `courses_x_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `courses_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `css_day`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `css_day` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `css_night`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `css_night` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
  `name` tinytext DEFAULT NULL,
  `value` tinytext DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `defined_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `defined_fields` (
...
DROP TABLE IF EXISTS `fac_case_cat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `fac_case_cat` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `fac_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `fac_status` (
  `id` bigint(4) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `fac_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `facnotes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `facnotes` (
...
DROP TABLE IF EXISTS `known_sources`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `mailgroup_x`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `mailgroup_x` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `mdb_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `mdb_files` (
...
DROP TABLE IF EXISTS `mdb_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `mdb_settings` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
  `name` tinytext DEFAULT NULL,
...
DROP TABLE IF EXISTS `messages_bin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `messages_bin` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `msg_type` int(2) NOT NULL,
  `message_id` varchar(24) DEFAULT NULL,
  `ticket_id` int(8) DEFAULT NULL,
...
DROP TABLE IF EXISTS `mi_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `mi_types` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `mmarkup_cats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `msg_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `patient_x`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `patient_x` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `pin_ctrl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `pin_ctrl` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `replacetext`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `replacetext` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `replacetext_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `replacetext_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `responder_rota`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `responder_rota` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `responder_x_member`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `responder_x_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `showin_contactlist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `showin_contactlist` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `skills_x_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `skills_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `states_translator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `states_translator` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `stats_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
DROP TABLE IF EXISTS `std_msgs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `std_msgs` (
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `name` varchar(48) NOT NULL,
...
DROP TABLE IF EXISTS `teams_x_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `teams_x_user` (
  `id` int(7) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tracks_hh`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tracks_hh` (
  `id` bigint(7) NOT NULL AUTO_INCREMENT,
  `source` varchar(96) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
...
set autocommit=0;
-- User seed rows intentionally stripped — see comment in the
-- parallel block of sql/base_schema.sql for the security
-- rationale (publicly-known MD5('admin') / MD5('guest') hashes).
-- Even in the wipe-and-reinstall RESET variant, we don't want
-- the well-known credentials silently reseeded.
...
DROP TABLE IF EXISTS `waste_basket_f`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `waste_basket_f` (
  `id` smallint(3) NOT NULL AUTO_INCREMENT,
  `member_id` smallint(3) NOT NULL,
  `name` varchar(64) NOT NULL,
  `shortname` varchar(32) NOT NULL,
...
DROP TABLE IF EXISTS `waste_basket_m`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `waste_basket_m` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `field1` varchar(28) DEFAULT NULL,
  `field2` varchar(28) DEFAULT NULL,
  `field3` int(4) NOT NULL DEFAULT 0,
